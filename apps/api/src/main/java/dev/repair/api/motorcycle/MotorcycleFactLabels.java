...
public final class MotorcycleFactLabels {
    ...
    private static final Map<String, String> LABELS = Map.ofEntries(
            ...
            Map.entry("OIL_FILTER_INITIAL_POINT_KM", "Oil filter initial replacement point"),
            Map.entry("OIL_FILTER_SCHEDULE_START_KM", "Oil filter first regular replacement point"),
            ...
            Map.entry("SPARK_PLUG_SCHEDULE_START_KM", "Spark plug first scheduled replacement point"),
